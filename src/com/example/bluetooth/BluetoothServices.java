...
/**
 * Created by Valera on 29.11.2015.
 */
...
public class BluetoothServices {
  ...
  // Key names received from the BluetoothServices Handler
   ...
   */
  public void flushingOutStream() throws IOException {
    if (mConnectedThread != null)
      mConnectedThread.flushStream();
  }
  ...
  private void connectionLost() {
    ...
    msg.setData(bundle);
    mHandler.sendMessage(msg);
    mHandler.obtainMessage(Constants.LOST_CONNECTION);
    // Start the service over to restart listening mode
    BluetoothServices.this.start();
  }
